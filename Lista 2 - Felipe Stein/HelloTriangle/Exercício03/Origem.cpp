// A VANTAGEM DESSA CONFIGURAÇÃO É QUE PODEMOS UTILIZAR O POSICIONAMENTO DOS OBJETOS DIRETAMENTO COM A POSIÇÃO EM PIXEL
...
//#endif
	...
	// EXERCÍCIO 2 //
	double xmin = 0, xmax = 800, ymin = 600, ymax = 0;
